...
import Task_Not_Done from './../assets/Task_Not_Done_Dark.png';   //icon for incomplete task
...
import Edit_Done from './../assets/Edit_Done_Dark.png'     //icon during task being edited
...
export default class SavedNote extends Component{
    ...
    constructor (props) {
        ...
        super()
            this.state = ({
                ...
                backColor:(props.task.status=="Complete"? '#444444':'grey'), 
                backColorTaskBox:(props.task.content==''? 'silver':'transparent'),
    ...
    change_status = () => {
        this.setState({
                ...
                backColor: (this.state.Task_Status==Task_Not_Done ?'#444444':'grey'),
    ...
    edit_task = () => {
        var date = new Date().toLocaleString();
            this.setState({
                ...
                'backColorTaskBox': (this.state.enableEditing ? 'transparent':'silver'),
