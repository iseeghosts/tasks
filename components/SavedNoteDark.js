            ...
            {/* main Container containing all children items */}
                <View style={mainbox2}>
                    ...
                    <View style={inputtask}>
                        <TextInput onEndEditing={()=> this.edit_task()} keyboardAppearance={AppData[this.props.id].theme} style={{color:'white', fontSize:15, fontStyle:'italic', paddingVertical:10}}
                    ...
                    <TouchableOpacity disabled={this.state.Task_Status==Task_Done || this.state.deletedTask} underlayColor="#000"  style={styles.edittextbox} onPress={ () => this.edit_task()}>
