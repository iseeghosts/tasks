...
import SavedNoteDark from './SavedNoteDark'
import SavedNoteLight from './SavedNoteLight'
    ...
    render() {
        ...
        if (search.slice(0,9)!='@deleted' && !deleted && found) {            
            if (AppData[this.props.id].theme=='dark') {
                return (
                    <View style={{flex:1}}>
                        <SavedNoteDark newtask={this.edit_task} delete={this.delete_task} task={this.props.task} id={this.props.id} search={this.props.search} />
                    </View>
                )
            } else {
                return (
                    <View style={{flex:1}}>
                        <SavedNoteLight newtask={this.edit_task} delete={this.delete_task} task={this.props.task} id={this.props.id} search={this.props.search} />
                    </View>
                )
            }
        }
